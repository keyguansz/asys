...
import com.android.settings.kdeprecated;
...
class AccessPoint extends Preference {
    ...
    /**
     *@desc
     *@ref:just for debug,wo can delete its!
     *@author : key.guan @ 2017/4/2 12:35
     */
    @kdeprecated
    ...
    private String getVisibilityStatus() {
        ...
        myLog(visibility.toString());

        return visibility.toString();
    }
    private void myLog(String log){
        Log.e("kg.Settings.AccessPoint",log);
    }
